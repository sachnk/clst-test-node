...
```sh
npm install git+ssh://git@github.com:sachnk/clst-test-node.git
```
...
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/sachnk/clst-test-node/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/sachnk/clst-test-node/issues) with questions, bugs, or suggestions.
