...
```sh
npm install git+ssh://git@github.com:stainless-sdks/clst-test-node.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainlessapi.com/docs/guides/publish), this will become: `npm install clst-test`
...
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/stainless-sdks/clst-test-node/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/clst-test-node/issues) with questions, bugs, or suggestions.
